...
public class CreateProductOutDtoTest {
    ...
    public void equalsAndHashCodeTest() {
        ...
        createProductOutDto = buildCreateProductOutDto("2id", name, description, quantity, price, discount,
                manufacturer, userId);
        assertNotEquals(createProductOutDto2, createProductOutDto);
        assertNotEquals(createProductOutDto2.hashCode(), createProductOutDto.hashCode());

        createProductOutDto = buildCreateProductOutDto(id, "changed", description, quantity, price, discount,
                manufacturer, userId);
        assertNotEquals(createProductOutDto2, createProductOutDto);
        assertNotEquals(createProductOutDto2.hashCode(), createProductOutDto.hashCode());

        createProductOutDto = buildCreateProductOutDto(id, name, "changed", quantity, price, discount, manufacturer,
                userId);
        assertNotEquals(createProductOutDto2, createProductOutDto);
        assertNotEquals(createProductOutDto2.hashCode(), createProductOutDto.hashCode());

        createProductOutDto = buildCreateProductOutDto(id, name, description, 2, price, discount, manufacturer, userId);
        assertNotEquals(createProductOutDto2, createProductOutDto);
        assertNotEquals(createProductOutDto2.hashCode(), createProductOutDto.hashCode());

        createProductOutDto = buildCreateProductOutDto(id, name, description, quantity, 3.0, discount, manufacturer,
                userId);
        assertNotEquals(createProductOutDto2, createProductOutDto);
        assertNotEquals(createProductOutDto2.hashCode(), createProductOutDto.hashCode());

        createProductOutDto = buildCreateProductOutDto(id, name, description, quantity, price, 4.0, manufacturer,
                userId);
        assertNotEquals(createProductOutDto2, createProductOutDto);
        assertNotEquals(createProductOutDto2.hashCode(), createProductOutDto.hashCode());

        createProductOutDto = buildCreateProductOutDto(id, name, description, quantity, price, discount, "changed",
                userId);
        assertNotEquals(createProductOutDto2, createProductOutDto);
        assertNotEquals(createProductOutDto2.hashCode(), createProductOutDto.hashCode());

        createProductOutDto = buildCreateProductOutDto(id, name, description, quantity, price, discount, manufacturer,
                3L);
        assertNotEquals(createProductOutDto2, createProductOutDto);
        assertNotEquals(createProductOutDto2.hashCode(), createProductOutDto.hashCode());
    }
