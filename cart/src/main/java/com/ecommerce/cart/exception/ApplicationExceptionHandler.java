...
import com.ecommerce.cart.domain.ErrorResponse;
...
public class ApplicationExceptionHandler {
    ...
    public final ResponseEntity<ErrorResponse> handleRecordAlreadyExistException(final RecordAlreadyExistsException ex) {
        List<String> errorMessages = new ArrayList<String>();
        errorMessages.add(ex.getMessage());
